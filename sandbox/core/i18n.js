...
export const translations = {
    en: {
        ...
        "providerGrokWeb": "Grok Web (Free, Login Required)",
        ...
        "promptDraft": "Custom Draft",
        "promptPresetName": "Preset Name",
        "promptPresetNamePlaceholder": "e.g. My Analyst Mode",
        "promptSavePreset": "Save Preset",
        "promptDeletePreset": "Delete Preset",
        "promptPresetHint": "Custom presets are stored locally. No front-end character limit is enforced here.",
        "promptPresetBuiltinTag": "Built-in",
        "promptPresetUserTag": "Custom",
        "promptPresetBrutal": "Brutal Truth Teller",
        "promptPresetUntrammelled": "Untrammelled Writer",
        "promptPresetNameRequired": "Enter a preset name first.",
        "promptDeleteSelectCustom": "Select a custom preset before deleting.",
        "promptPresetBuiltinDeleteBlocked": "Built-in presets cannot be deleted.",
        "promptDeletePresetConfirm": "Delete this custom preset?",
        "promptSavePresetOverwriteConfirm": "A custom preset with this name already exists. Overwrite it?",
    ...
    zh: {
        ...
        "providerXai": "xAI Grok API",
        "providerGrokWeb": "Grok 网页版 (免费, 需要登录)",
        ...
        "promptDraft": "自定义草稿",
        "promptPresetName": "预设名称",
        "promptPresetNamePlaceholder": "例如：我的分析模式",
        "promptSavePreset": "保存预设",
        "promptDeletePreset": "删除预设",
        "promptPresetHint": "自定义预设保存在本地，这里不做前端字数限制。",
        "promptPresetBuiltinTag": "内置",
        "promptPresetUserTag": "自定义",
        "promptPresetBrutal": "吐槽毒舌",
        "promptPresetUntrammelled": "桀骜不驯",
        "promptPresetNameRequired": "请先输入预设名称。",
        "promptDeleteSelectCustom": "请先选择一个自定义预设再删除。",
        "promptPresetBuiltinDeleteBlocked": "内置预设不能删除。",
        "promptDeletePresetConfirm": "确认删除这个自定义预设？",
        "promptSavePresetOverwriteConfirm": "已存在同名自定义预设，是否覆盖？",
        "systemDefault": "跟随系统",
        "light": "浅色",
        "dark": "深色",
